  ...
  return (
    <header className="backdrop-blur-md bg-white/10 border-b border-white/20 px-4 py-3 fixed top-0 w-full z-50 mb-44">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <Link href="/">
            <span className="text-2xl font-bold text-white drop-shadow-lg cursor-pointer">HermantoXYZ</span>
          </Link>
        </div>
        <nav className="flex items-center space-x-6">
          ...
          <a href="#search" className="text-white hover:text-blue-300 transition">Search API</a> */}
           <Link href="/kurs" className="text-white hover:text-blue-300 transition">USD/IDR</Link>
          <a 
